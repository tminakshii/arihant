...
const LeftSideQuetions = () => {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={styles.mainviewareaL}>
        <TouchableOpacity
          ...
          <Image source={ImagePath.sidearrow} style={styles.sidearrowL} />
        </TouchableOpacity>

        <View style={styles.arrowbackL}>
          <ScrollView
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.headerquestion,
                    {
                      ...
                      borderEndEndRadius:
                        selectedQuestion === index ? width * 0.028 : null,
          ...
          <Image
            source={ImagePath.longarrowright_side}
            style={styles.imagelong}
          />
        </View>

        <View style={styles.sideupperboxL}>
          ...
          <View>
            <View style={styles.quetionDetailsL}>
          ...
          <View style={styles.footerContainerL}>
            <Button
            ...
            <Button
              text={'Skip'}
              customStyles={styles.footerButtonstyleR2}
              textStyle={styles.footerbuttontextstyleR}
            />
          </View>
        </View>
...
export default LeftSideQuetions;
